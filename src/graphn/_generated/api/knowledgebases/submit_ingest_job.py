...
from ...models.submit_ingest_job_request import SubmitIngestJobRequest
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 202:
        response_202 = IngestJob.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    """Submit an async URL-ingest job
