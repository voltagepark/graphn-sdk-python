...
T = TypeVar("T", bound="IngestItemInput")
...
class IngestItemInput:
    ...
    Attributes:
        ...
        metadata (IngestItemInputMetadata | Unset):
    """
    ...
    metadata: IngestItemInputMetadata | Unset = UNSET
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if isinstance(_metadata, Unset):
            ...
            metadata = IngestItemInputMetadata.from_dict(_metadata)

        ingest_item_input = cls(
            url=url,
            filename=filename,
