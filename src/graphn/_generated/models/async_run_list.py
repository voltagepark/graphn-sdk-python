...
if TYPE_CHECKING:
    from ..models.async_run import AsyncRun


T = TypeVar("T", bound="AsyncRunList")
...
class AsyncRunList:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        for items_item_data in _items:
            items_item = AsyncRun.from_dict(items_item_data)
        ...
        async_run_list.additional_properties = d
        return async_run_list
