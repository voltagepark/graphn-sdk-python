...
if TYPE_CHECKING:
    from ..models.function_create_files import FunctionCreateFiles
    from ..models.function_create_parameters_schema import (
...
class FunctionCreate:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        if isinstance(_files, Unset):
            ...
            files = FunctionCreateFiles.from_dict(_files)
        ...
        if isinstance(_parameters_schema, Unset):
            ...
            parameters_schema = FunctionCreateParametersSchema.from_dict(
                _parameters_schema
            )
