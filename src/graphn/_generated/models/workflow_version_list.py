...
T = TypeVar("T", bound="WorkflowVersionList")


@_attrs_define
class WorkflowVersionList:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        workflow_version_list = cls(
            versions=versions,
            published_version_id=published_version_id,
        )

        workflow_version_list.additional_properties = d
        return workflow_version_list
